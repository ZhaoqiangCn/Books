...
[_https://namithhosmane.blog/2017/03/16/virtual-machinevm-setup-to-access-dynamics-365-for-operation-instance/_](https://namithhosmane.blog/2017/03/16/virtual-machinevm-setup-to-access-dynamics-365-for-operation-instance/)\_\_
...
#### _Installation of Hyper-V in Windows Server 2012 or Windows server 2012 R2 by using PowerShell_
...
_Install-WindowsFeature –Name Hyper-V -ComputerName -IncludeManagementTools -Restart_
...
#### _Install the Hyper-V role on Windows 8 or Windows 8.1, Windows 10.0_
...
_enable-WindowsOptionalFeature -Online -FeatureName Microsoft-Hyper-V –All_
...
#### _Provision the administrator user._
